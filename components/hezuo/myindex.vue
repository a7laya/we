<template>
  <div>
    <x-header :title="'众包列表'" :left-options="{backText:''}">
      <div slot="right">
    ...
    <template v-if="index==1">
      <div v-for="(item,index) in list">
        <vue-list :type="1" :item="item" :key="index">
          <div class="remove_butt" v-if="item.end_time>dangqian_time/1000" >
    ...
    <template v-if="index==2">
      ...
      <vue-loading :url="$store.state.url + '/Homecenter/my_canyu?type=2&page=1&limit=10'" @ievent="loaddata"></vue-loading>
    </template>
    <!-- 活动 结束 -->
