<template>
	<div style="background:#fff;">
		...
		<div class="touch">
			<div class="fazhuan" >
				<!-- <h4>招标信息</h4> -->
				<div style="margin-bottom:10px">单位：{{list.agent}}</div>
				<div style="margin-bottom:10px">姓名：{{list.agent_name}}</div>
