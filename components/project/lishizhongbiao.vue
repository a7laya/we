<template>
	<div style="background: #fff;">
		...
		<div class="zhongbiao">
			<vue-message :type="5" v-for="(item,index) in lists" :key="index" :item="item"></vue-message>
			<vue-loading :url="$store.state.url + '/Collection/historyWinB?page=1&limit=10&win_company_id='+$route.query.id" @ievent="loaddata" v-if="isshow"></vue-loading>
		</div>
